...
$CONFIGURE_IN = '/tmp/portage.tmp/portage/net-vpn/tor-0.3.1.5_alpha/work/tor-0.3.1.5-alpha/configure.ac';
$ORCONFIG_H = '/tmp/portage.tmp/portage/net-vpn/tor-0.3.1.5_alpha/work/tor-0.3.1.5-alpha/src/win32/orconfig.h';
$TOR_NSI = '/tmp/portage.tmp/portage/net-vpn/tor-0.3.1.5_alpha/work/tor-0.3.1.5-alpha/contrib/win32build/tor-mingw.nsi.in';
