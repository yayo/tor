...
#define BUILDDIR "/tmp/portage.tmp/portage/net-vpn/tor-0.3.1.5_alpha/work/tor-0.3.1.5-alpha"
...
#define PACKAGE_STRING "tor 0.3.1.5-alpha"
...
#define PACKAGE_VERSION "0.3.1.5-alpha"
